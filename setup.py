...
PACKAGE_NAME = "refgenie_myplugin"
...
setup(
    ...
    entry_points={
        'refgenie.hooks.post_update': 'refgenie_myplugin=refgenie_myplugin:my_post_update_func',
        'refgenie.hooks.pre_pull': 'refgenie_myplugin=refgenie_myplugin:my_pre_pull_func',
        }
)
